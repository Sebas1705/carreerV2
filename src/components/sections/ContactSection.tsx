      ...
      <div className="max-w-2xl w-full text-center">
        ...
        >
          <a
            ...
            className="px-7 py-3 bg-violet-600 hover:bg-violet-700 text-white rounded-full font-semibold transition-all duration-200 hover:scale-105 shadow-lg shadow-violet-500/30"
          >
            {t('contact.email_cta')}
          </a>
          <a
            href="https://github.com/sebssgarcia502580"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-7 py-3 border border-slate-200 dark:border-slate-700 rounded-full font-semibold hover:border-violet-400 dark:hover:border-violet-500 hover:text-violet-600 dark:hover:text-violet-400 transition-all duration-200 hover:scale-105"
          >
            <GitHubIcon />
            GitHub
          </a>
